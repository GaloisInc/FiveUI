...
public class RuleSet {
   ...
   /** 
    * Function wrapper around `RuleSet.parse` for use in 
    * `transform` and other functional combinators.
    */
   ...
   public RuleSet(String name, String description, ImmutableList<Rule> immutableList) {
      _name = name;
